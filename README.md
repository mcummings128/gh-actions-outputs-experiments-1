...
- <ins>Caller workflow and composite action</ins>: In this context, the 'caller workflow' refers to a workflow that calls a composite action. A composite action
